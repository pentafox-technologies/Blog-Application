  ...
  async function handleSubmit() {
    ...
    await axios
      ...
      .then((response) => {
        ...
        Cookies.set("userType", response.data.data.user[0].userType, {
          expires: 30,
        });
        Cookies.set("userName", response.data.data.user[0].userName, {
          expires: 30,
        });
  ...
  return (
    <>
        ...
        <Grid item xs={12}>
          ...
          >
            <InputLabel
              ...
              className={logincss.gridpasslabel}
            >
              Password
            </InputLabel>
            <OutlinedInput
          ...
          {!allDetails && (
            <Typography
              gutterBottom
              style={{ color: "red", marginTop: "8px", fontWeight: "600" }}
              align="center"
            >
      ...
      >
        <Grid item xs={5}>
          <Typography
            style={{ color: "#6246ea", fontWeight: "600", marginTop: "5px" }}
            variant="body1"
            gutterBottom
            className={logincss.forget}
          >
            Forgot Password?
          </Typography>
        </Grid>
